...
export const NoiseBackground = ({
    ...
    return (
        <div
            ref={containerRef}
            className={cn(
                "group relative overflow-hidden rounded-[999px] bg-neutral-200 p-2 backdrop-blur-sm dark:bg-neutral-800",
        ...
        >
            ...
            <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[999px]">
                <img
                    ...
                    alt=""
                    className="h-full w-full object-cover opacity-[var(--noise-opacity)] rounded-[999px]"
